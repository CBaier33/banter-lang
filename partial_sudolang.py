...
tokens = [
    ...
    #Indentation
    'INDENT', 'DEDENT'] + list(set(reserved.values()))
...
def p_statement_if(p):
    '''statement : IF comparison COMMA THEN INDENT statements DEDENT'''
    p[0] = IfStatement(expr=p[2], do=p[5])

def p_statement_if_else(p):
    '''statement : IF comparison COMMA THEN INDENT statements DEDENT ELSE statements'''
...
print(parser.parse('''let wrong be 3
let right be 7
