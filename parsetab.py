...
_lr_productions = [
  ...
  ('program -> statement','program',1,'p_program','sudolang.py',105),
  ('program -> program statement','program',2,'p_program','sudolang.py',106),
  ('program -> expression','program',1,'p_program','sudolang.py',107),
  ('statement -> LET MNEUMONIC BE expression','statement',4,'p_statement_let','sudolang.py',121),
  ('statement -> IF comparison COMMA THEN statement','statement',5,'p_statement_if','sudolang.py',125),
  ('statement -> IF comparison COMMA THEN statement ELSE statement','statement',7,'p_statement_if_else','sudolang.py',129),
  ('statement -> RETURN expression','statement',2,'p_statement_return','sudolang.py',133),
  ('statement -> GOTO INSTRUCTION NUMBER','statement',3,'p_statement_goto','sudolang.py',137),
  ('statement -> MARKER NUMBER','statement',2,'p_statement_marker','sudolang.py',141),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','sudolang.py',146),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','sudolang.py',147),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','sudolang.py',148),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','sudolang.py',149),
  ('expression -> NUMBER','expression',1,'p_expression_number','sudolang.py',153),
  ('expression -> STRING','expression',1,'p_expression_string','sudolang.py',157),
  ('expression -> MNEUMONIC','expression',1,'p_expression_mneumonic','sudolang.py',161),
  ('expression -> BOOL','expression',1,'p_expression_bool','sudolang.py',165),
  ('expression -> LP expression RP','expression',3,'p_expression_group','sudolang.py',172),
  ('expression -> comparison','expression',1,'p_expression_comparison','sudolang.py',176),
  ('comparison -> expression COMP_OP expression','comparison',3,'p_comparison','sudolang.py',180),
]
